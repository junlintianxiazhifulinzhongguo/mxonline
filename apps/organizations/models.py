...
class CourseOrg(BaseModel):
    ...
    image = models.ImageField(max_length=150, verbose_name='logo', upload_to='org/%Y/%m/%d')
...
class Teacher(BaseModel):
    ...
    image = models.ImageField(max_length=150, verbose_name='头像', upload_to='teacher/%Y/%m/%d')
